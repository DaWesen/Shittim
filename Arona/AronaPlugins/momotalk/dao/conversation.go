...
// SaveConversationWithVectors 保存对话（包含向量）
func (dao *ConversationDAO) SaveConversationWithVectors(userID int64, userMessage, botResponse string,
	userMessageVector, botResponseVector, topicVector interface{}) error {
	// 创建对话
	conversation := models.Conversation{
		UserID:     userID,
		StartAt:    time.Now(),
